            ...
            <div className="content">
                ...
                <div className="front">
                    ...
                    <div className="front-content">
                        {/* <small className="badge">{card}</small> */}
                        <div className="description">
                            <div className="title">
                                <div className="title" style={{ width: 'auto' }}>
                                    <ul style={{ marginRight: '5px' }}>
                                        <li style={{ paddingBottom: '10px' }}>
                                            <strong>{card.description[0]}</strong>

                                        </li>
                                        <li style={{ paddingTop: '10px', marginBottom: "10px" }}>
                                            <strong>{card.description[1]}</strong>
