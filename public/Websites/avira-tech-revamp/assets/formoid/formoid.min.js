...
//         var t = "https://formoid.net/api/push",
//             o = {
//                 type: "POST",
//                 data: JSON.stringify({
...
//     var t, o = e.tagName === "FORM" ? e : e.querySelector("form"),
...
//         if (e.target.type === "file" && e.target.files[0].size > 1e6) {
...
//                     if (e.getAttribute("name") === "email" && !isValidEmail(e)) {
...
var Formoid = (function () {
    ...
    t.prototype.send = function (e) {
        var t = "https://formoid.net/api/push",  // Check if this URL is valid
            o = {
                type: "POST",
                data: JSON.stringify({
                    email: this.__email__,
        ...
        return new Promise(function (e, n) {
            ...
            r.open(o.type, t);
            r.onload = function () {
                if (r.status !== 200) return n(new Error("Incorrect server response."));
                e(r.responseText);
            };
            r.onerror = function () {
                var errorMessage = "Failed to query the server. ";
                errorMessage += navigator.onLine ? "Check the connection and try again." : "No connection to the Internet.";
                n(new Error(errorMessage));
            };
            r.send(o.data);
        })
        .then(function (e) {
...
var isValidEmail = function (e) {
    return !e.value || /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.value); // Simplified regex for email validation
};
...
formComponents.forEach(function (e) {
    var t,
        o = e.tagName === "FORM" ? e : e.querySelector("form"),
        n = e.querySelector("[data-form-alert]"),
        r = e.getAttribute("data-form-title") ? e : e.querySelector("[data-form-title]"),
        a = e.querySelector('[type="submit"]'),
        l = e.querySelectorAll("[data-form-field]"),
    ...
    o.addEventListener("change", function (e) {
        if (e.target.type === "file" && e.target.files[0].size > 1048576) { // 1 MB file size limit
            formModal._element.querySelector(".modal-body p").innerText = "File size must be less than 1MB";
            formModal._element.querySelector(".modal-content").classList.add("alert-danger");
            formModal._element.querySelector(".modal-content").style.backgroundColor = "#ff9966";
            formModal.show();
    ...
    o.addEventListener("submit", function (s) {
        ...
        if (!a.classList.contains("btn-loading")) {
            var d = l;
            o.classList.add("form-active");
            a.classList.add("btn-loading");
            a.setAttribute("disabled", true);
